...
class OWHierarchicalClustering(OWWidget):
    ...
    def commit_data(self):
        ...
        self.selectionChanged = False
        self.selectedExamples = None
        Dend_sel_items = self.dendrogram.widget.selected_items              # qPCR4vir:   workaround. on_selection_change dont get called
        self.selected_clusters = [item.cluster for item in Dend_sel_items]  # qPCR4vir
